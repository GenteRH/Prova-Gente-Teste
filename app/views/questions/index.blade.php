...
@endif
<a href="{{ URL::to('questions/create') }}"><button type="button"  id="botao" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Criar</button></a>
<table class="table table-striped table-hover" id="index" align="center" >
    ...
    <tbody>
      ...
      <tr>
          <td>{{ $value->id }}</td>
          <td>{{ $value->que_name }}</td>
          <td>{{ $value->que_category }}</td>

          <!-- we will also add show, edit, and delete buttons -->
          <td>
            <a href="{{ URL::to('questions/delete/' . $value->id . '/') }}">
             ...
             <a href="{{ URL::to('questions/' . $value->id . '/edit') }}">
