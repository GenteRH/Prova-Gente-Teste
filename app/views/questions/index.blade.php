...
<a href="{{ URL::to('users/create') }}"><button type="button"  id="botao" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Criar</button></a>
<table class="table table-striped table-hover" id="index" align="center" >
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="{{ URL::to('users/delete/' . $value->id . '/') }}">
