                        ...
                        <ul class="nav" id="side-menu">
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="{{ URL::to('evaluations/index') }}"><i class="fa fa-angle-double-right"></i>   Avaliação</a>
                                    </li>
                                    <li>
                                        <a href="{{ URL::to('questions/index') }}"><i class="fa fa-angle-double-right"></i>   Pergunta</a>
                                    </li>
                                    <li>
                                        <a href="{{ URL::to('users/index') }}"><i class="fa fa-angle-double-right"></i>   Usuário</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
