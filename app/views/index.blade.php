...
<body>
    ...
    <link href="{{ asset('assets/default/js/jquery-1.11.0.js') }}" rel="stylesheet" type='text/css'>

    <!-- Bootstrap Core JavaScript -->
    <script src="js/bootstrap.min.js"></script>
    <link href="{{ asset('assets/default/js/bootstrap.min.js') }}" rel="stylesheet" type='text/css'>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="js/plugins/metisMenu/metisMenu.min.js"></script>
    <link href="{{ asset('assets/default/js/metisMenu.min.js') }}" rel="stylesheet" type='text/css'>

    <!-- Morris Charts JavaScript -->
    <script src="js/plugins/morris/raphael.min.js"></script>
    <script src="js/plugins/morris/morris.min.js"></script>
    <script src="js/plugins/morris/morris-data.js"></script>
    <link href="{{ asset('assets/default/js/raphael.min.js') }}" rel="stylesheet" type='text/css'>
    <link href="{{ asset('assets/default/js/morris.min.js') }}" rel="stylesheet" type='text/css'>
    <link href="{{ asset('assets/default/js/morris-data.js') }}" rel="stylesheet" type='text/css'>

    <!-- Custom Theme JavaScript -->
    <script src="js/sb-admin-2.js"></script>
    <link href="{{ asset('assets/default/js/sb-admin-2.js') }}" rel="stylesheet" type='text/css'>
